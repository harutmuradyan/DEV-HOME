...
const MessengerBtn= () => {
    return (
        <div className="messengerBtn-block">
            <img    className="messengerBtn-block__img" 
                    src="https://www.pngarts.com/files/6/User-Avatar-in-Suit-PNG.png" alt=""></img>
            <span className="messengerBtn-block__sessionOn"></span>
