    ...
    return (
        <div className="newMessag">
            <div className="newMessag-header">
                <img className="newMessag-header__img" src="https://www.pngarts.com/files/6/User-Avatar-in-Suit-PNG.png" alt=""></img>
            ...
            <div className="newMessag-container">
                ...
                <div className="newMessag-user__insertMess">
                    <input className="newMessag-user__insertMess-text" placeholder="   Գրեք Տեքստը"/>
